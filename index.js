...
function getDataFromForm() {
  ...
  // 2 => Double Pendulum
    ...
    pendulumData = {
      ...
      trajectory: document.getElementById("switch").checked,                     // Shows the Trajectory of the Second Mass         
      RK4: document.getElementById("RK4switch").checked                          // Determines the Type of Numerical Integration Used               
    };
  }
...
function start(typeOfPendulum, pendulumData) {
   ...
   *  DoublePendulum => { count, dt, mass1, length1, mass2, length2, angle1, angle2, trajectory, RK4 }
   */
  ...
  const RK4 = pendulumData.RK4;                           // Determines the Type of Numerical Integration
...
function addToggle() {
  ...
  // RK4 Integration CheckBox 
  const RK4label = document.createElement('label');
  RK4label.id = "RK4-label-toggle";
  RK4label.appendChild(document.createTextNode("RK4 Integration: "));
  RK4label.htmlFor = "checkbox";

  const RK4input = document.createElement('input');
